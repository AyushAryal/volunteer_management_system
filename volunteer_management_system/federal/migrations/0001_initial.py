    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=30)),
                ('description', ckeditor.fields.RichTextField()),
                ('incident', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='federal.incident')),
            ],
        ),
        migrations.CreateModel(
            name='Job',
            fields=[
                ...
                ('volunteers', models.ManyToManyField(blank=True, related_name='jobs', to='federal.profile', verbose_name='Volunteers Employed')),
                ('programme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='federal.programme')),
            ],
        ),
        migrations.AddField(
            model_name='district',
