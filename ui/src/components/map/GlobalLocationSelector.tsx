  ...
  return (
    <LocationSelector
      ...
      onChangeSelectedProvince={(value) =>
        mapControlsSelectedProvince.set(value)
      }
      selectedDistrict={mapControlsSelectedDistrict.get()}
      onChangeSelectedDistrict={(value) =>
        mapControlsSelectedDistrict.set(value)
      }
      selectedMunicipality={mapControlsSelectedMunicipality.get()}
      onChangeSelectedMunicipality={(value) =>
        mapControlsSelectedMunicipality.set(value)
      }
